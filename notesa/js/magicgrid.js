!(function (t, e) {
  ...
  var t = function (t) {
      ...
      "boolean" != typeof t.useTransform && (t.useTransform = !0),
        "number" != typeof t.gutter && (t.gutter = 25),
        t.container || e("container"),
        t.items || t.static || e("items or static");
    },
    e = function (t) {
      ...
      t(e),
        e.container instanceof HTMLElement
          ? ((this.container = e.container),
            (this.containerClass = e.container.className))
          : ((this.containerClass = e.container),
    ...
    (n.prototype.positionItems = function () {
      ...
      for (var o = 0; o < this.items.length; o++) {
        var r = this.nextCol(e, o),
          ...
          u = r.height + h + "px";
        this.useTransform
          ? (a.style.transform = "translate(" + c + ", " + u + ")")
          : ((a.style.top = u), (a.style.left = c)),
          (r.height += a.getBoundingClientRect().height + h),
      ...
      var t = this,
        e = setInterval(function () {
          (t.container = document.querySelector(t.containerClass)),
            ...
            t.ready() && (clearInterval(e), t.init(), t.listen());
        }, 100);
    }),
